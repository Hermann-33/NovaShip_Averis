  ...
  return (
    <div className="space-y-3">
      ...
      {[...c.drafts].reverse().map((d) => (
        <Card key={d.id} title={<span>{d.draft_type.replace(/_/g, " ")} · v{d.version} <Badge className={{ PROPOSED: "bg-accent-bg text-accent-fg", EDITED: "bg-review-bg text-review-fg", APPROVED: "bg-match-bg text-match-fg", SENT: "bg-match text-white", SIMULATED: "bg-match-bg text-match-fg", SEND_FAILED: "bg-mismatch-bg text-mismatch-fg", REJECTED: "bg-mismatch-bg text-mismatch-fg" }[d.status] || ""}>{d.status}</Badge></span>}
